...
const objLat = (obj) => {
    ...
    let capFirstName = obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1).toLowerCase();
    let capLastName = obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1).toLowerCase();

    let theText = `my name is ${capFirstName} ${capLastName} I am ${obj.age} YO, and I love ${obj.hobby}.`;
